...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7270442919:AAGTv2v9pcsP7G6c-EACMWXbjaTOjDNwdyk")  # ⚠️ Required
    ...
    FORCE_SUB = os.environ.get("FORCE_SUB", "-1002019186374") # ⚠️ Required Username without @
